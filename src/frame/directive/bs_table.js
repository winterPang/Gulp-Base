define(['jquery', 'angularAMD', 'frame/directive/lang/bs_table', 'utils',
        ...
        'bootstrapDatepicker', 'frame/libs/rangepicker/rangepicker'],
        ...
        app.constant('bsTableDef', $.extend(true, {}, $.fn.bootstrapTable.defaults, {
            ...
            var _picker = {
                ...
                eventHandle: function (ev, picker) {
                    var $this = $(this), v = picker.startDate.format(picker.locale.format) + picker.locale.separator + picker.endDate.format(picker.locale.format);
                    var _old = $this.val();
